...
<body>
    ...
    <div class="header-container">
      ...
      <div class="menu">
        <ul class="menu1">
		  ...
		  <li><a href="#" class="active">Grievance List</a></li> 
  ...
  <table style="background-color: aliceblue;top:20" class='table table-hover'>
    <thead>
        <tr>
            <th>No</th>
            <th>Voter ID</th>
      ...
      {{-- @if($voter)
        ...
        @foreach ($grievances as $grievance)
            ...
            <tr>
                ...
                <td>{{ $grievance->constituency }}</td>
                <form action="/editVoter" method="POST">
                  @csrf
                <input type="text" hidden name="ID" value={{$grievance->voterID}}>
                <td><button class="btn-edit" type="submit">Respond</button></td>
              </form>         
            </tr>
            <?php
        $n=$n+1;
